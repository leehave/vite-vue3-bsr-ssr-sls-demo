import { MarkdownRenderOption, getMarkdownSplitIndex, markdownToHTML } from '/@/transforms/markdown'
...
import { getStaticPath, getStaticURL, isOriginalStaticURL } from '/@/transforms/url'
