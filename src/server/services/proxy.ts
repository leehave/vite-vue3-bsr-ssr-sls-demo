import { BAD_REQUEST, FORBIDDEN, INVALID_ERROR } from '@/constants/http-code'
import { BFF_PROXY_ALLOWLIST_REGEXP, BFF_PROXY_PREFIX, getStaticURL } from '@/config/bff.config'
