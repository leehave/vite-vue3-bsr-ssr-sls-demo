...
<template>
  <div id="player" :class="{ playing: state.playing }" v-disabled-wallflower>
    <div class="panel">
      <div class="control">
        <button class="prev-song button" :disabled="!state.initialized" @click="player.prevSong">
          <i class="iconfont icon-music-prev"></i>
        </button>
        <button class="next-song button" :disabled="!state.initialized" @click="player.nextSong">
          <i class="iconfont icon-music-next"></i>
        </button>
        <button class="muted-toggle button" :disabled="!state.initialized" @click="player.toggleMuted">
          <i class="iconfont" :class="state.muted ? 'icon-music-muted' : 'icon-music-unmuted'"></i>
        </button>
        <button class="player button" @click="togglePlayerModel">
          <i class="iconfont icon-netease-music"></i>
        </button>
      </div>
      <button class="song-link" @click="togglePlayerModel">
    ...
    <div class="cd">
      ...
      <button class="toggle-button" :disabled="!state.initialized" @click="player.togglePlay">
