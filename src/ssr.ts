...
import { INVALID_ERROR, SUCCESS } from './constants/http-code'
import { MainApp, createMainApp } from '/@/app/main'
import { SSRHeadPayload, renderSSRHead } from '@unhead/ssr'
import { THEME_STORAGE_KEY, Theme } from '/@/composables/theme'
import { renderSSRContextScript, renderSSRStateScript } from '/@/universal'
...
const createApp = (ssrContext: SSRContext): MainApp => {
  ...
  const hackComponents = ['progress-bar', 'popup-root', 'popup']
